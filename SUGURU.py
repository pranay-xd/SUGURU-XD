...
def contact():
	...
	os.system('xdg-open https://www.facebook.com/uknowsarita')
...
\033[1;32m----------------------------------------------
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃SUGURU⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
❣︎[𖣘]☔︎CREATED BY   :  SUGURU_XD
❣︎[𖣘]☔︎ FB NAME     : SUGURU
❣︎[𖣘]☔︎ON GITHUB    :  SUGURU_XD
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[SUGURU]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
